...
/** @file cuarma/scheduler/execute_util.hpp
 *  @encoding:UTF-8 文档编码
...
/** @brief Helper routine for extracting the context in which a statement is executed.
  ...
  */
inline cuarma::context extract_context(statement_node const & root_node)
{
  if (root_node.lhs.type_family == SCALAR_TYPE_FAMILY)
  {
    ...
    {
    case CHAR_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_char);
    case UCHAR_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_char);
    case SHORT_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_short);
    case USHORT_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_ushort);
    case INT_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_int);
    case UINT_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_uint);
    case LONG_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_long);
    case ULONG_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_ulong);
      //case HALF_TYPE:
      //return cuarma::traits::context(*root_node.lhs.scalar_half);
    case FLOAT_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_float);
    case DOUBLE_TYPE:
      return cuarma::traits::context(*root_node.lhs.scalar_double);
    default:
  ...
  else if (root_node.lhs.type_family == VECTOR_TYPE_FAMILY)
  {
    ...
    {
    case CHAR_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_char);
    case UCHAR_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_char);
    case SHORT_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_short);
    case USHORT_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_ushort);
    case INT_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_int);
    case UINT_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_uint);
    case LONG_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_long);
    case ULONG_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_ulong);
      //case HALF_TYPE:
      //return cuarma::traits::context(*root_node.lhs.vector_half);
    case FLOAT_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_float);
    case DOUBLE_TYPE:
      return cuarma::traits::context(*root_node.lhs.vector_double);
    default:
  ...
  else if (root_node.lhs.type_family == MATRIX_TYPE_FAMILY)
  {
    ...
    {
    case CHAR_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_char);
    case UCHAR_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_char);
    case SHORT_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_short);
    case USHORT_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_ushort);
    case INT_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_int);
    case UINT_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_uint);
    case LONG_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_long);
    case ULONG_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_ulong);
      //case HALF_TYPE:
      //return cuarma::traits::context(*root_node.lhs.matrix_half);
    case FLOAT_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_float);
    case DOUBLE_TYPE:
      return cuarma::traits::context(*root_node.lhs.matrix_double);
    default:
...
inline void new_element(lhs_rhs_element & new_elem, lhs_rhs_element const & old_element, cuarma::context const & ctx)
{
  ...
  if (new_elem.type_family == SCALAR_TYPE_FAMILY)
  {
    ...
    {
    case FLOAT_TYPE:
      new_elem.scalar_float = new cuarma::scalar<float>(0, ctx);
      return;
    case DOUBLE_TYPE:
      new_elem.scalar_double = new cuarma::scalar<double>(0, ctx);
      return;
    default:
  ...
  else if (new_elem.type_family == VECTOR_TYPE_FAMILY)
  {
    ...
    {
    case FLOAT_TYPE:
      new_elem.vector_float = new cuarma::vector<float>((old_element.vector_float)->size(), ctx);
      return;
    case DOUBLE_TYPE:
      new_elem.vector_double = new cuarma::vector<double>((old_element.vector_float)->size(), ctx);
      return;
    default:
      throw statement_not_supported_exception("Invalid vector type for vector construction");
    }
  ...
  else if (new_elem.type_family == MATRIX_TYPE_FAMILY)
  {
    ...
    if (new_elem.subtype == DENSE_MATRIX_TYPE)
    {
      ...
      {
      case FLOAT_TYPE:
        new_elem.matrix_float = new cuarma::matrix_base<float>((old_element.matrix_float)->size1(), (old_element.matrix_float)->size2(), (old_element.matrix_float)->row_major(), ctx);
        return;
      case DOUBLE_TYPE:
        new_elem.matrix_double = new cuarma::matrix_base<double>((old_element.matrix_double)->size1(), (old_element.matrix_double)->size2(), (old_element.matrix_double)->row_major(), ctx);
        return;
      default:
        throw statement_not_supported_exception("Invalid vector type for vector construction");
      }
