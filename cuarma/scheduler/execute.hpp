...
/** @file cuarma/scheduler/execute.hpp
 *  @encoding:UTF-8 文档编码
...
#include "cuarma/scheduler/execute_scalar_assign.hpp"
#include "cuarma/scheduler/execute_axbx.hpp"
#include "cuarma/scheduler/execute_elementwise.hpp"
#include "cuarma/scheduler/execute_matrix_prod.hpp"
...
namespace detail
{
  ...
  void execute_composite(statement const & s, statement_node const & root_node)
  {
    ...
    cuarma::context ctx = extract_context(root_node);
