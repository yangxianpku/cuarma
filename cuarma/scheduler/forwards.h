...
/** @file cuarma/scheduler/forwards.h
 *  @encoding:UTF-8 文档编码
...
public:
  ...
  statement_not_supported_exception(std::string message) : message_("cuarma: Internal error: The scheduler encountered a problem with the operation provided: " + message) {}
...
struct lhs_rhs_element
{
  ...
  union
  {
    ...
    // Note: cuarma types have potentially expensive copy-CTORs, hence using pointers:

    // scalars:
    cuarma::scalar<char>             *scalar_char;
    cuarma::scalar<unsigned char>    *scalar_uchar;
    cuarma::scalar<short>            *scalar_short;
    cuarma::scalar<unsigned short>   *scalar_ushort;
    cuarma::scalar<int>              *scalar_int;
    cuarma::scalar<unsigned int>     *scalar_uint;
    cuarma::scalar<long>             *scalar_long;
    cuarma::scalar<unsigned long>    *scalar_ulong;
    cuarma::scalar<float>            *scalar_float;
    cuarma::scalar<double>           *scalar_double;

    // vectors:
    cuarma::vector_base<char>             *vector_char;
    cuarma::vector_base<unsigned char>    *vector_uchar;
    cuarma::vector_base<short>            *vector_short;
    cuarma::vector_base<unsigned short>   *vector_ushort;
    cuarma::vector_base<int>              *vector_int;
    cuarma::vector_base<unsigned int>     *vector_uint;
    cuarma::vector_base<long>             *vector_long;
    cuarma::vector_base<unsigned long>    *vector_ulong;
    cuarma::vector_base<float>            *vector_float;
    cuarma::vector_base<double>           *vector_double;

    // implicit vectors:
    cuarma::implicit_vector_base<char>             *implicit_vector_char;
    cuarma::implicit_vector_base<unsigned char>    *implicit_vector_uchar;
    cuarma::implicit_vector_base<short>            *implicit_vector_short;
    cuarma::implicit_vector_base<unsigned short>   *implicit_vector_ushort;
    cuarma::implicit_vector_base<int>              *implicit_vector_int;
    cuarma::implicit_vector_base<unsigned int>     *implicit_vector_uint;
    cuarma::implicit_vector_base<long>             *implicit_vector_long;
    cuarma::implicit_vector_base<unsigned long>    *implicit_vector_ulong;
    cuarma::implicit_vector_base<float>            *implicit_vector_float;
    cuarma::implicit_vector_base<double>           *implicit_vector_double;

    // dense matrices:
    cuarma::matrix_base<char>             *matrix_char;
    cuarma::matrix_base<unsigned char>    *matrix_uchar;
    cuarma::matrix_base<short>            *matrix_short;
    cuarma::matrix_base<unsigned short>   *matrix_ushort;
    cuarma::matrix_base<int>              *matrix_int;
    cuarma::matrix_base<unsigned int>     *matrix_uint;
    cuarma::matrix_base<long>             *matrix_long;
    cuarma::matrix_base<unsigned long>    *matrix_ulong;
    cuarma::matrix_base<float>            *matrix_float;
    cuarma::matrix_base<double>           *matrix_double;

    cuarma::implicit_matrix_base<char>             *implicit_matrix_char;
    cuarma::implicit_matrix_base<unsigned char>    *implicit_matrix_uchar;
    cuarma::implicit_matrix_base<short>            *implicit_matrix_short;
    cuarma::implicit_matrix_base<unsigned short>   *implicit_matrix_ushort;
    cuarma::implicit_matrix_base<int>              *implicit_matrix_int;
    cuarma::implicit_matrix_base<unsigned int>     *implicit_matrix_uint;
    cuarma::implicit_matrix_base<long>             *implicit_matrix_long;
    cuarma::implicit_matrix_base<unsigned long>    *implicit_matrix_ulong;
    cuarma::implicit_matrix_base<float>            *implicit_matrix_float;
    cuarma::implicit_matrix_base<double>           *implicit_matrix_double;

    //cuarma::compressed_matrix<float>    *compressed_matrix_char;
    //cuarma::compressed_matrix<double>   *compressed_matrix_uchar;
    //cuarma::compressed_matrix<float>    *compressed_matrix_short;
    //cuarma::compressed_matrix<double>   *compressed_matrix_ushort;
    //cuarma::compressed_matrix<float>    *compressed_matrix_int;
    //cuarma::compressed_matrix<double>   *compressed_matrix_uint;
    //cuarma::compressed_matrix<float>    *compressed_matrix_long;
    //cuarma::compressed_matrix<double>   *compressed_matrix_ulong;
    cuarma::compressed_matrix<float>    *compressed_matrix_float;
    cuarma::compressed_matrix<double>   *compressed_matrix_double;

    //cuarma::coordinate_matrix<float>    *coordinate_matrix_char;
    //cuarma::coordinate_matrix<double>   *coordinate_matrix_uchar;
    //cuarma::coordinate_matrix<float>    *coordinate_matrix_short;
    //cuarma::coordinate_matrix<double>   *coordinate_matrix_ushort;
    //cuarma::coordinate_matrix<float>    *coordinate_matrix_int;
    //cuarma::coordinate_matrix<double>   *coordinate_matrix_uint;
    //cuarma::coordinate_matrix<float>    *coordinate_matrix_long;
    //cuarma::coordinate_matrix<double>   *coordinate_matrix_ulong;
    cuarma::coordinate_matrix<float>    *coordinate_matrix_float;
    cuarma::coordinate_matrix<double>   *coordinate_matrix_double;

    //cuarma::ell_matrix<float>    *ell_matrix_char;
    //cuarma::ell_matrix<double>   *ell_matrix_uchar;
    //cuarma::ell_matrix<float>    *ell_matrix_short;
    //cuarma::ell_matrix<double>   *ell_matrix_ushort;
    //cuarma::ell_matrix<float>    *ell_matrix_int;
    //cuarma::ell_matrix<double>   *ell_matrix_uint;
    //cuarma::ell_matrix<float>    *ell_matrix_long;
    //cuarma::ell_matrix<double>   *ell_matrix_ulong;
    cuarma::ell_matrix<float>    *ell_matrix_float;
    cuarma::ell_matrix<double>   *ell_matrix_double;

    //cuarma::hyb_matrix<float>    *hyb_matrix_char;
    //cuarma::hyb_matrix<double>   *hyb_matrix_uchar;
    //cuarma::hyb_matrix<float>    *hyb_matrix_short;
    //cuarma::hyb_matrix<double>   *hyb_matrix_ushort;
    //cuarma::hyb_matrix<float>    *hyb_matrix_int;
    //cuarma::hyb_matrix<double>   *hyb_matrix_uint;
    //cuarma::hyb_matrix<float>    *hyb_matrix_long;
    //cuarma::hyb_matrix<double>   *hyb_matrix_ulong;
    cuarma::hyb_matrix<float>    *hyb_matrix_float;
    cuarma::hyb_matrix<double>   *hyb_matrix_double;
  };
};
...
public:
  ...
  typedef cuarma::arma_size_t        size_type;
  ...
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<char>  const & t) { elem.scalar_char  = const_cast<cuarma::scalar<char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<unsigned char>  const & t) { elem.scalar_uchar  = const_cast<cuarma::scalar<unsigned char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<short>  const & t) { elem.scalar_short  = const_cast<cuarma::scalar<short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<unsigned short>  const & t) { elem.scalar_ushort  = const_cast<cuarma::scalar<unsigned short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<int>  const & t) { elem.scalar_int  = const_cast<cuarma::scalar<int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<unsigned int>  const & t) { elem.scalar_uint  = const_cast<cuarma::scalar<unsigned int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<long>  const & t) { elem.scalar_long  = const_cast<cuarma::scalar<long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<unsigned long>  const & t) { elem.scalar_ulong  = const_cast<cuarma::scalar<unsigned long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<float>  const & t) { elem.scalar_float  = const_cast<cuarma::scalar<float> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::scalar<double> const & t) { elem.scalar_double = const_cast<cuarma::scalar<double> *>(&t); }

  ///////////// Vector node helper ////////////////
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<char>  const & t) { elem.vector_char  = const_cast<cuarma::vector_base<char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<unsigned char>  const & t) { elem.vector_uchar  = const_cast<cuarma::vector_base<unsigned char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<short>  const & t) { elem.vector_short  = const_cast<cuarma::vector_base<short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<unsigned short>  const & t) { elem.vector_ushort  = const_cast<cuarma::vector_base<unsigned short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<int>  const & t) { elem.vector_int  = const_cast<cuarma::vector_base<int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<unsigned int>  const & t) { elem.vector_uint  = const_cast<cuarma::vector_base<unsigned int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<long>  const & t) { elem.vector_long  = const_cast<cuarma::vector_base<long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<unsigned long>  const & t) { elem.vector_ulong  = const_cast<cuarma::vector_base<unsigned long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<float>  const & t) { elem.vector_float  = const_cast<cuarma::vector_base<float> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::vector_base<double> const & t) { elem.vector_double = const_cast<cuarma::vector_base<double> *>(&t); }

  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<char>  const & t) { elem.implicit_vector_char  = const_cast<cuarma::implicit_vector_base<char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<unsigned char>  const & t) { elem.implicit_vector_uchar  = const_cast<cuarma::implicit_vector_base<unsigned char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<short>  const & t) { elem.implicit_vector_short  = const_cast<cuarma::implicit_vector_base<short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<unsigned short>  const & t) { elem.implicit_vector_ushort  = const_cast<cuarma::implicit_vector_base<unsigned short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<int>  const & t) { elem.implicit_vector_int  = const_cast<cuarma::implicit_vector_base<int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<unsigned int>  const & t) { elem.implicit_vector_uint  = const_cast<cuarma::implicit_vector_base<unsigned int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<long>  const & t) { elem.implicit_vector_long  = const_cast<cuarma::implicit_vector_base<long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<unsigned long>  const & t) { elem.implicit_vector_ulong  = const_cast<cuarma::implicit_vector_base<unsigned long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<float>  const & t) { elem.implicit_vector_float  = const_cast<cuarma::implicit_vector_base<float> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_vector_base<double> const & t) { elem.implicit_vector_double = const_cast<cuarma::implicit_vector_base<double> *>(&t); }

  ///////////// Matrix node helper ////////////////
  // TODO: add integer matrix overloads here
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<char>  const & t) { elem.matrix_char  = const_cast<cuarma::matrix_base<char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<unsigned char>  const & t) { elem.matrix_uchar  = const_cast<cuarma::matrix_base<unsigned char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<short>  const & t) { elem.matrix_short  = const_cast<cuarma::matrix_base<short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<unsigned short>  const & t) { elem.matrix_ushort  = const_cast<cuarma::matrix_base<unsigned short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<int>  const & t) { elem.matrix_int  = const_cast<cuarma::matrix_base<int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<unsigned int>  const & t) { elem.matrix_uint  = const_cast<cuarma::matrix_base<unsigned int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<long>  const & t) { elem.matrix_long  = const_cast<cuarma::matrix_base<long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<unsigned long>  const & t) { elem.matrix_ulong  = const_cast<cuarma::matrix_base<unsigned long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<float> const & t) { elem.matrix_float  = const_cast<cuarma::matrix_base<float> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::matrix_base<double> const & t) { elem.matrix_double = const_cast<cuarma::matrix_base<double> *>(&t); }

  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<char>  const & t) { elem.implicit_matrix_char  = const_cast<cuarma::implicit_matrix_base<char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<unsigned char>  const & t) { elem.implicit_matrix_uchar  = const_cast<cuarma::implicit_matrix_base<unsigned char> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<short>  const & t) { elem.implicit_matrix_short  = const_cast<cuarma::implicit_matrix_base<short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<unsigned short>  const & t) { elem.implicit_matrix_ushort  = const_cast<cuarma::implicit_matrix_base<unsigned short> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<int>  const & t) { elem.implicit_matrix_int  = const_cast<cuarma::implicit_matrix_base<int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<unsigned int>  const & t) { elem.implicit_matrix_uint  = const_cast<cuarma::implicit_matrix_base<unsigned int> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<long>  const & t) { elem.implicit_matrix_long  = const_cast<cuarma::implicit_matrix_base<long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<unsigned long>  const & t) { elem.implicit_matrix_ulong  = const_cast<cuarma::implicit_matrix_base<unsigned long> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<float> const & t) { elem.implicit_matrix_float  = const_cast<cuarma::implicit_matrix_base<float> *>(&t); }
  static void assign_element(lhs_rhs_element & elem, cuarma::implicit_matrix_base<double> const & t) { elem.implicit_matrix_double = const_cast<cuarma::implicit_matrix_base<double> *>(&t); }

  static void assign_element(lhs_rhs_element & elem, cuarma::compressed_matrix<float>  const & m) { elem.compressed_matrix_float  = const_cast<cuarma::compressed_matrix<float>  *>(&m); }
  static void assign_element(lhs_rhs_element & elem, cuarma::compressed_matrix<double> const & m) { elem.compressed_matrix_double = const_cast<cuarma::compressed_matrix<double> *>(&m); }

  static void assign_element(lhs_rhs_element & elem, cuarma::coordinate_matrix<float>  const & m) { elem.coordinate_matrix_float  = const_cast<cuarma::coordinate_matrix<float>  *>(&m); }
  static void assign_element(lhs_rhs_element & elem, cuarma::coordinate_matrix<double> const & m) { elem.coordinate_matrix_double = const_cast<cuarma::coordinate_matrix<double> *>(&m); }

  static void assign_element(lhs_rhs_element & elem, cuarma::ell_matrix<float>  const & m) { elem.ell_matrix_float  = const_cast<cuarma::ell_matrix<float>  *>(&m); }
  static void assign_element(lhs_rhs_element & elem, cuarma::ell_matrix<double> const & m) { elem.ell_matrix_double = const_cast<cuarma::ell_matrix<double> *>(&m); }

  static void assign_element(lhs_rhs_element & elem, cuarma::hyb_matrix<float>  const & m) { elem.hyb_matrix_float  = const_cast<cuarma::hyb_matrix<float>  *>(&m); }
  static void assign_element(lhs_rhs_element & elem, cuarma::hyb_matrix<double> const & m) { elem.hyb_matrix_double = const_cast<cuarma::hyb_matrix<double> *>(&m); }

  //////////// Tree leaves (terminals) ////////////////////

  template<class T>
  static typename cuarma::enable_if<cuarma::is_primitive_type<T>::value, arma_size_t>::type
  add_element(arma_size_t       next_free,
  ...
  template<typename T>
  static arma_size_t add_element(arma_size_t next_free,
                                lhs_rhs_element            & elem,
                                cuarma::scalar<T> const & t)
  {
    elem.type_family  = SCALAR_TYPE_FAMILY;
  ...
  static arma_size_t add_element(arma_size_t next_free,
                                lhs_rhs_element            & elem,
                                cuarma::implicit_vector_base<T> const & t)
  {
    elem.type_family           = VECTOR_TYPE_FAMILY;
  ...
  static arma_size_t add_element(arma_size_t next_free,
                                lhs_rhs_element            & elem,
                                cuarma::implicit_matrix_base<T> const & t)
  {
    elem.type_family  = MATRIX_TYPE_FAMILY;
  ...
  static arma_size_t add_element(arma_size_t next_free,
                                lhs_rhs_element            & elem,
                                cuarma::compressed_matrix<T> const & t)
  {
    elem.type_family  = MATRIX_TYPE_FAMILY;
  ...
  static arma_size_t add_element(arma_size_t next_free,
                                lhs_rhs_element            & elem,
                                cuarma::coordinate_matrix<T> const & t)
  {
    elem.type_family  = MATRIX_TYPE_FAMILY;
...
private:
  ...
  arma_size_t add_element(arma_size_t       next_free,
                         lhs_rhs_element & elem,
                         cuarma::scalar_expression<LHS, RHS, OP> const & t)
  {
  ...
  arma_size_t add_element(arma_size_t       next_free,
                         lhs_rhs_element & elem,
                         cuarma::vector_expression<LHS, RHS, OP> const & t)
  {
    elem.type_family  = COMPOSITE_OPERATION_FAMILY;
    elem.subtype      = INVALID_SUBTYPE;
    elem.numeric_type = INVALID_NUMERIC_TYPE;
  ...
  arma_size_t add_element(arma_size_t next_free,
                         lhs_rhs_element & elem,
                         cuarma::matrix_expression<LHS, RHS, OP> const & t)
  {
    elem.type_family   = COMPOSITE_OPERATION_FAMILY;
    elem.subtype      = INVALID_SUBTYPE;
    elem.numeric_type = INVALID_NUMERIC_TYPE;
  ...
  template<typename T>
  arma_size_t add_lhs(arma_size_t current_index, arma_size_t next_free, T const & t)
  {
    return add_element(next_free, array_[current_index].lhs, t);
  }

  template<typename T>
  arma_size_t add_rhs(arma_size_t current_index, arma_size_t next_free, T const & t)
  {
  ...
  arma_size_t add_node(arma_size_t current_index, arma_size_t next_free, ExpressionT<LHS, RHS, OP> const & proxy)
  {
    // set OP:
