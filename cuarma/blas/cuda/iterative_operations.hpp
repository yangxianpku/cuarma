...
/** @file cuarma/blas/cuda/iterative_operations.hpp
 *  @encoding:UTF-8 文档编码
                                ...
                                vector_base<NumericT> & inner_prod_buffer)
{
  ...
  pipelined_cg_vector_kernel<<<128, 128>>>(cuarma::cuda_arg(result),
                                           alpha,
                                           cuarma::cuda_arg(p),
                                           cuarma::cuda_arg(r),
                                           cuarma::cuda_arg(Ap),
                                           beta,
                                           cuarma::cuda_arg(inner_prod_buffer),
                                           size);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_cg_vector_kernel");
}
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  if (double(A.nnz()) / double(A.size1()) > 12.0) // less than 25% of threads expected to idle
  {
    ...
    CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_cg_csr_vec_mul_blocked_kernel");
  }
  else
  {
    pipelined_cg_csr_vec_mul_adaptive_kernel<<<256, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle1()),
                                                           cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                           cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                           cuarma::cuda_arg<NumericT>(A.handle()),
                                                           ...
                                                           cuarma::cuda_arg(inner_prod_buffer),
                                                           buffer_size_per_vector);
    CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_cg_csr_vec_mul_kernel");
  }
}
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  pipelined_cg_coo_vec_mul_kernel<<<64, 128>>>(cuarma::cuda_arg<unsigned int>(A.handle12()),
                                                cuarma::cuda_arg<NumericT>(A.handle()),
                                                cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                cuarma::cuda_arg(p),
                                                cuarma::cuda_arg(Ap),
                                                ...
                                                cuarma::cuda_arg(inner_prod_buffer),
                                                buffer_size_per_vector);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_cg_coo_vec_mul_kernel");
}
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  pipelined_cg_ell_vec_mul_kernel<<<256, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                cuarma::cuda_arg<NumericT>(A.handle()),
                                                ...
                                                cuarma::cuda_arg(inner_prod_buffer),
                                                buffer_size_per_vector);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_cg_ell_vec_mul_kernel");
}
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  pipelined_cg_sliced_ell_vec_mul_kernel<<<256, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle1()),
                                                       cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                       cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                       cuarma::cuda_arg<NumericT>(A.handle()),
                                                       cuarma::cuda_arg(p),
                                                       ...
                                                       cuarma::cuda_arg(inner_prod_buffer),
                                                       buffer_size_per_vector);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_cg_sliced_ell_vec_mul_kernel");
}
                       ...
                       vector_base<NumericT> & inner_prod_buffer)
{
  ...
  pipelined_cg_hyb_vec_mul_kernel<<<256, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                cuarma::cuda_arg<NumericT>(A.handle()),
                                                cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                cuarma::cuda_arg<unsigned int>(A.handle4()),
                                                cuarma::cuda_arg<NumericT>(A.handle5()),
                                                static_cast<unsigned int>(A.internal_size1()),
                                                ...
                                                cuarma::cuda_arg(inner_prod_buffer),
                                                buffer_size_per_vector);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_cg_hyb_vec_mul_kernel");
}
                                 ...
                                 arma_size_t buffer_chunk_offset)
{
  ...
  pipelined_bicgstab_update_s_kernel<<<256, 256>>>(cuarma::cuda_arg(s),
                                                   cuarma::cuda_arg(r),
                                                   cuarma::cuda_arg(Ap),
                                                   size,
                                                   cuarma::cuda_arg(inner_prod_buffer),
                                                   chunk_size,
                                                   chunk_offset);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_bicgstab_update_s_kernel");
}
...
void pipelined_bicgstab_vector_update(vector_base<NumericT> & result, NumericT alpha, vector_base<NumericT> & p, NumericT omega, vector_base<NumericT> const & s,
                                      ...
                                      vector_base<NumericT> & inner_prod_buffer, arma_size_t buffer_chunk_size)
{
  (void)buffer_chunk_size;
  unsigned int size = static_cast<unsigned int>(result.size());

  pipelined_bicgstab_vector_kernel<<<256, 256>>>(cuarma::cuda_arg(result),
                                                 alpha,
                                                 cuarma::cuda_arg(p),
                                                 omega,
                                                 cuarma::cuda_arg(s),
                                                 cuarma::cuda_arg(residual),
                                                 cuarma::cuda_arg(As),
                                                 beta,
                                                 cuarma::cuda_arg(Ap),
                                                 cuarma::cuda_arg(r0star),
                                                 cuarma::cuda_arg(inner_prod_buffer),
                                                 size);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_bicgstab_vector_kernel");
}
...
void pipelined_bicgstab_prod(compressed_matrix<NumericT> const & A,
                             ...
                             arma_size_t buffer_chunk_offset)
{
  unsigned int vec_size     = static_cast<unsigned int>(cuarma::traits::size(p));
  unsigned int chunk_size   = static_cast<unsigned int>(buffer_chunk_size);
  unsigned int chunk_offset = static_cast<unsigned int>(buffer_chunk_offset);
  ...
  {
    pipelined_bicgstab_csr_vec_mul_adaptive_kernel<<<256, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle1()),
                                                                cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                                cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                                cuarma::cuda_arg<NumericT>(A.handle()),
                                                                static_cast<unsigned int>(A.blocks1()),
                                                                ...
                                                                chunk_size,
                                                                chunk_offset);
    CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_bicgstab_csr_vec_mul_adaptive_kernel");
  }
}
                             ...
                             arma_size_t buffer_chunk_offset)
{
  ...
  pipelined_bicgstab_coo_vec_mul_kernel<<<64, 128>>>(cuarma::cuda_arg<unsigned int>(A.handle12()),
                                                      cuarma::cuda_arg<NumericT>(A.handle()),
                                                      cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                      cuarma::cuda_arg(p),
                                                      cuarma::cuda_arg(Ap),
                                                      ...
                                                      chunk_size,
                                                      chunk_offset);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_bicgstab_coo_vec_mul_kernel");
}
                             ...
                             arma_size_t buffer_chunk_offset)
{
  ...
  pipelined_bicgstab_ell_vec_mul_kernel<<<256, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                      cuarma::cuda_arg<NumericT>(A.handle()),
                                                      static_cast<unsigned int>(A.internal_size1()),
                                                      static_cast<unsigned int>(A.maxnnz()),
                                                      cuarma::cuda_arg(p),
                                                      ...
                                                      chunk_size,
                                                      chunk_offset);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_bicgstab_ell_vec_mul_kernel");
}
                             ...
                             arma_size_t buffer_chunk_offset)
{
  ...
  pipelined_bicgstab_sliced_ell_vec_mul_kernel<<<256, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle1()),
                                                             cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                             cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                             cuarma::cuda_arg<NumericT>(A.handle()),
                                                             cuarma::cuda_arg(p),
                                                             ...
                                                             chunk_size,
                                                             chunk_offset);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_bicgstab_sliced_ell_vec_mul_kernel");
}
                             ...
                             arma_size_t buffer_chunk_offset)
{
  ...
  pipelined_bicgstab_hyb_vec_mul_kernel<<<256, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                      cuarma::cuda_arg<NumericT>(A.handle()),
                                                      cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                      cuarma::cuda_arg<unsigned int>(A.handle4()),
                                                      cuarma::cuda_arg<NumericT>(A.handle5()),
                                                      ...
                                                      chunk_size,
                                                      chunk_offset);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_bicgstab_hyb_vec_mul_kernel");
}
...
void pipelined_gmres_normalize_vk(vector_base<T> & v_k,
                                  ...
                                  arma_size_t buffer_chunk_offset)
{
  unsigned int vk_offset = cuarma::traits::start(v_k);
  ...
  pipelined_gmres_normalize_vk_kernel<<<128, 128>>>(cuarma::cuda_arg(v_k),
                                                    vk_offset,
                                                    cuarma::cuda_arg(residual),
                                                    cuarma::cuda_arg(R_buffer),
                                                    R_offset,
                                                    cuarma::cuda_arg(inner_prod_buffer),
                                                    chunk_size,
                                                    cuarma::cuda_arg(r_dot_vk_buffer),
                                                    chunk_offset,
                                                    size);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_gmres_normalize_vk_kernel");
}
                                         ...
                                         arma_size_t buffer_chunk_size)
{
  ...
  pipelined_gmres_gram_schmidt_stage1_kernel<<<128, 128>>>(cuarma::cuda_arg(device_krylov_basis),
                                                           size,
                                                           internal_size,
                                                           k,
                                                           cuarma::cuda_arg(vi_in_vk_buffer),
                                                           chunk_size);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_gmres_gram_schmidt_stage1_kernel");
}
                                         ...
                                         arma_size_t buffer_chunk_size)
{
  ...
  pipelined_gmres_gram_schmidt_stage2_kernel<<<128, 128>>>(cuarma::cuda_arg(device_krylov_basis),
                                                           size,
                                                           internal_size,
                                                           k,
                                                           cuarma::cuda_arg(vi_in_vk_buffer),
                                                           ...
                                                           krylov,
                                                           cuarma::cuda_arg(inner_prod_buffer));
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_gmres_gram_schmidt_stage2_kernel");
}
                                   ...
                                   arma_size_t param_k)
{
  ...
  pipelined_gmres_update_result_kernel<<<128, 128>>>(cuarma::cuda_arg(result),
                                                     cuarma::cuda_arg(residual),
                                                     cuarma::cuda_arg(krylov_basis),
                                                     size,
                                                     internal_size,
                                                     cuarma::cuda_arg(coefficients),
                                                     k);
  CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_gmres_update_result_kernel");
}
                          ...
                          vector_base<NumericT> & inner_prod_buffer)
{
  ...
  if (double(A.nnz()) / double(A.size1()) > 12.0) // less than 25% of threads expected to idle
  {
    pipelined_cg_csr_vec_mul_blocked_kernel<16, NumericT><<<128, 256>>>(   // Fermi and Kepler prefer 16 threads per row (half-warp)
                                                                        ...
                                                                        cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                                        cuarma::cuda_arg<NumericT>(A.handle()),
                                                                        cuarma::cuda_arg(p) + cuarma::traits::start(p),
                                                                        cuarma::cuda_arg(Ap) + cuarma::traits::start(Ap),
                                                                        size,
                                                                        cuarma::cuda_arg(inner_prod_buffer),
                                                                        buffer_size_per_vector
                                                                       );
  ...
  {
    pipelined_cg_csr_vec_mul_adaptive_kernel<<<128, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle1()),
                                                           cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                           cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                           cuarma::cuda_arg<NumericT>(A.handle()),
                                                           static_cast<unsigned int>(A.blocks1()),
                                                           ...
                                                           cuarma::cuda_arg(inner_prod_buffer),
                                                           buffer_size_per_vector);
    CUARMA_CUDA_LAST_ERROR_CHECK("pipelined_cg_csr_vec_mul_adaptive_kernel");
  }
                          ...
                          vector_base<T> & inner_prod_buffer)
{
  ...
  pipelined_cg_ell_vec_mul_kernel<<<128, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                cuarma::cuda_arg<T>(A.handle()),
                                                static_cast<unsigned int>(A.internal_size1()),
                                                static_cast<unsigned int>(A.maxnnz()),
                                                cuarma::cuda_arg(p) + cuarma::traits::start(p),
                          ...
                          vector_base<T> & inner_prod_buffer)
{
  ...
  pipelined_cg_sliced_ell_vec_mul_kernel<<<128, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle1()),
                                                       cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                       cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                       cuarma::cuda_arg<T>(A.handle()),
                                                       cuarma::cuda_arg(p) + cuarma::traits::start(p),
                          ...
                          vector_base<T> & inner_prod_buffer)
{
  ...
  pipelined_cg_hyb_vec_mul_kernel<<<128, 256>>>(cuarma::cuda_arg<unsigned int>(A.handle2()),
                                                cuarma::cuda_arg<T>(A.handle()),
                                                cuarma::cuda_arg<unsigned int>(A.handle3()),
                                                cuarma::cuda_arg<unsigned int>(A.handle4()),
                                                cuarma::cuda_arg<T>(A.handle5()),
                                                static_cast<unsigned int>(A.internal_size1()),
                                                static_cast<unsigned int>(A.ell_nnz()),
                                                cuarma::cuda_arg(p) + cuarma::traits::start(p),
                                                cuarma::cuda_arg(Ap) + cuarma::traits::start(Ap),
