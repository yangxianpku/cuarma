...
{
  convert_kernel<<<128, 128>>>(cuarma::cuda_arg(dest),
                              static_cast<unsigned int>(cuarma::traits::start(dest)),
                              static_cast<unsigned int>(cuarma::traits::stride(dest)),
                              static_cast<unsigned int>(cuarma::traits::size(dest)),

                              cuarma::cuda_arg(src),
                              static_cast<unsigned int>(cuarma::traits::start(src)),
                              static_cast<unsigned int>(cuarma::traits::stride(src)) );
  CUARMA_CUDA_LAST_ERROR_CHECK("convert_kernel");
}
...
void av(vector_base<NumericT> & vec1,
        vector_base<NumericT> const & vec2, ScalarType1 const & alpha, arma_size_t len_alpha, bool reciprocal_alpha, bool flip_sign_alpha)
{
  ...
  if (cuarma::is_cpu_scalar<ScalarType1>::value)
    temporary_alpha = alpha;

  av_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
          ...
          vector_base<NumericT> const & vec3, ScalarT2 const & beta,  arma_size_t len_beta,  bool reciprocal_beta,  bool flip_sign_beta)
{
  ...
  avbv_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                            static_cast<unsigned int>(cuarma::traits::start(vec1)),
                            static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                            static_cast<unsigned int>(cuarma::traits::size(vec1)),
                            ...
                            options_beta,
                            cuarma::cuda_arg(vec3),
                            static_cast<unsigned int>(cuarma::traits::start(vec3)),
                            static_cast<unsigned int>(cuarma::traits::stride(vec3)) );
  CUARMA_CUDA_LAST_ERROR_CHECK("avbv_kernel");
}
            ...
            vector_base<NumericT> const & vec3, ScalarT2 const & beta,  arma_size_t len_beta,  bool reciprocal_beta,  bool flip_sign_beta)
{
  ...
  avbv_v_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                              static_cast<unsigned int>(cuarma::traits::start(vec1)),
                              static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                              static_cast<unsigned int>(cuarma::traits::size(vec1)),
...
void vector_assign(vector_base<NumericT> & vec1, ScalarT1 const & alpha, bool up_to_internal_size = false)
{
  ...
  unsigned int size = up_to_internal_size ? static_cast<unsigned int>(vec1.internal_size()) : static_cast<unsigned int>(cuarma::traits::size(vec1));

  vector_assign_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                     static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                     static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                     size,
                                     ...
                                     cuarma::cuda_arg<value_type>(detail::arg_reference(alpha, temporary_alpha)) );
  CUARMA_CUDA_LAST_ERROR_CHECK("vector_assign_kernel");
}
...
{
  vector_swap_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                   static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                   static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                   static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                   ...
                                   static_cast<unsigned int>(cuarma::traits::start(vec2)),
                                   static_cast<unsigned int>(cuarma::traits::stride(vec2)) );
  CUARMA_CUDA_LAST_ERROR_CHECK("vector_swap_kernel");
}
                ...
                vector_expression<const vector_base<NumericT>, const vector_base<NumericT>, op_element_binary<OpT> > const & proxy)
{
  ...
  element_op_int_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                  static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                  static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                  static_cast<unsigned int>(cuarma::traits::size(vec1)),

                                  cuarma::cuda_arg(proxy.lhs()),
                                  static_cast<unsigned int>(cuarma::traits::start(proxy.lhs())),
                                  static_cast<unsigned int>(cuarma::traits::stride(proxy.lhs())),

                                  cuarma::cuda_arg(proxy.rhs()),
                                  static_cast<unsigned int>(cuarma::traits::start(proxy.rhs())),
                                  static_cast<unsigned int>(cuarma::traits::stride(proxy.rhs())),

                                  op_type
                                 );
  CUARMA_CUDA_LAST_ERROR_CHECK("element_op_kernel");
}
                ...
                vector_expression<const vector_base<float>, const vector_base<float>, op_element_binary<OpT> > const & proxy)
{
  ...
  element_op_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                  static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                  static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                  static_cast<unsigned int>(cuarma::traits::size(vec1)),
                ...
                vector_expression<const vector_base<NumericT>, const vector_base<NumericT>, op_element_unary<op_acos> > const & proxy)
{
  ...
  vec_element_acos_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_acos_kernel");
}
...
{
  vec_element_asin_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_asin_kernel");
}
...
{
  vec_element_atan_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_atan_kernel");
}
...
{
  vec_element_ceil_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_ceil_kernel");
}
...
{
  vec_element_cos_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_cos_kernel");
}
...
{
  vec_element_cosh_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_cosh_kernel");
}
...
{
  vec_element_exp_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_exp_kernel");
}
...
{
  vec_element_fabs_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_fabs_kernel");
}
...
{
  vec_element_abs_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                       static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                       static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                       static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                       cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_abs_kernel");
}
...
{
  vec_element_floor_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_floor_kernel");
}
...
{
  vec_element_log_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_log_kernel");
}
...
{
  vec_element_log10_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_log10_kernel");
}
...
{
  vec_element_sin_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_sin_kernel");
}
...
{
  vec_element_sinh_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_sinh_kernel");
}
...
{
  vec_element_sqrt_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_sqrt_kernel");
}
...
{
  vec_element_tan_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_tan_kernel");
}
...
{
  vec_element_tanh_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                        static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                        static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                        cuarma::cuda_arg(proxy.lhs()),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vec_element_tanh_kernel");
}
...
namespace detail
{
  ...
  struct vector_sum_kernel_launcher_integers
  {
    ...
    {
      typedef NumericT        value_type;
      vector_sum_kernel_integers<<<1, 128>>>(cuarma::cuda_arg(temp),
                                            static_cast<unsigned int>(cuarma::traits::start(temp)),
                                            static_cast<unsigned int>(cuarma::traits::stride(temp)),
                                            static_cast<unsigned int>(cuarma::traits::size(temp)),
                                            static_cast<unsigned int>(option),
                                            cuarma::cuda_arg(result) );
      CUARMA_CUDA_LAST_ERROR_CHECK("vector_sum_kernel");
    }
  };
  ...
  struct vector_sum_kernel_launcher_unsigned_integers
  {
    ...
    {
      typedef NumericT        value_type;
      vector_sum_kernel_unsigned_integers<<<1, 128>>>(cuarma::cuda_arg(temp),
                                                      static_cast<unsigned int>(cuarma::traits::start(temp)),
                                                      static_cast<unsigned int>(cuarma::traits::stride(temp)),
                                                      static_cast<unsigned int>(cuarma::traits::size(temp)),
                                                      static_cast<unsigned int>(option),
  ...
  struct vector_sum_kernel_launcher_floats
  {
    ...
    {
      typedef NumericT        value_type;
      vector_sum_kernel_floats<<<1, 128>>>(cuarma::cuda_arg(temp),
                                            static_cast<unsigned int>(cuarma::traits::start(temp)),
                                            static_cast<unsigned int>(cuarma::traits::stride(temp)),
                                            static_cast<unsigned int>(cuarma::traits::size(temp)),
                                            static_cast<unsigned int>(option),
                     ...
                     ScalarT & result)
{
  ...
  static cuarma::vector<value_type> temp(work_groups);

  inner_prod_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                  static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                  static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                  static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                  cuarma::cuda_arg(vec2),
                                  ...
                                  cuarma::cuda_arg(temp)
                                 );
  CUARMA_CUDA_LAST_ERROR_CHECK("inner_prod_kernel");
                    ...
                    NumericT & result)
{
  ...
  cuarma::vector<value_type> temp(work_groups);
  ...
  cuarma::fast_copy(temp.begin(), temp.end(), temp_cpu.begin());
...
#define CUARMA_MDOT_WORKGROUP_SIZE  128
#define CUARMA_MDOT_WORKGROUP_NUM   128
// M = 2:
template<typename NumericT>
...
{
  __shared__ NumericT tmp_buffer[2*CUARMA_MDOT_WORKGROUP_SIZE];
...
__global__ void inner_prod_3_kernel(const NumericT *x,  unsigned int startx, unsigned int stridex, unsigned int sizex,
                                    ...
                                    NumericT *group_results)
{
  __shared__ NumericT tmp_buffer[3*CUARMA_MDOT_WORKGROUP_SIZE];
  unsigned int entries_per_thread = (sizex - 1) / (blockDim.x * gridDim.x) + 1;
  unsigned int vec_start_index = blockIdx.x * blockDim.x * entries_per_thread;
...
__global__ void inner_prod_4_kernel(const NumericT *x,  unsigned int startx, unsigned int stridex, unsigned int sizex,
                                    ...
                                    NumericT *group_results)
{
  __shared__ NumericT tmp_buffer[4*CUARMA_MDOT_WORKGROUP_SIZE];
  unsigned int entries_per_thread = (sizex - 1) / (blockDim.x * gridDim.x) + 1;
  unsigned int vec_start_index = blockIdx.x * blockDim.x * entries_per_thread;
  unsigned int vec_stop_index  = min((blockIdx.x + 1) * blockDim.x * entries_per_thread, sizex); // don't go beyond vec size
...
__global__ void inner_prod_8_kernel(const NumericT *x,  unsigned int startx, unsigned int stridex, unsigned int sizex,
                                    ...
                                    NumericT *group_results)
{
  __shared__ NumericT tmp_buffer[8*CUARMA_MDOT_WORKGROUP_SIZE];
  unsigned int entries_per_thread = (sizex - 1) / (blockDim.x * gridDim.x) + 1;
  unsigned int vec_start_index = blockIdx.x * blockDim.x * entries_per_thread;
  unsigned int vec_stop_index  = min((blockIdx.x + 1) * blockDim.x * entries_per_thread, sizex); // don't go beyond vec size
...
{
  __shared__ NumericT tmp_buffer[CUARMA_MDOT_WORKGROUP_SIZE];

  tmp_buffer[threadIdx.x] = vec1[threadIdx.x + blockIdx.x * CUARMA_MDOT_WORKGROUP_SIZE];
                     ...
                     vector_base<NumericT> & result)
{
  ...
  static cuarma::vector<value_type> temp(8 * CUARMA_MDOT_WORKGROUP_NUM);

  arma_size_t current_index = 0;
  while (vec_tuple.const_size() > current_index)
  {
    switch (vec_tuple.const_size() - current_index)
    {
      ...
      case 4:
      {
        ...
        inner_prod_4_kernel<<<CUARMA_MDOT_WORKGROUP_NUM,
                              CUARMA_MDOT_WORKGROUP_SIZE>>>( cuarma::cuda_arg(x),
                                                               static_cast<unsigned int>(cuarma::traits::start(x)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(x)),
                                                               static_cast<unsigned int>(cuarma::traits::size(x)),
                                                               cuarma::cuda_arg(y0),
                                                               static_cast<unsigned int>(cuarma::traits::start(y0)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(y0)),
                                                               cuarma::cuda_arg(y1),
                                                               static_cast<unsigned int>(cuarma::traits::start(y1)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(y1)),
                                                               cuarma::cuda_arg(y2),
                                                               static_cast<unsigned int>(cuarma::traits::start(y2)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(y2)),
                                                               cuarma::cuda_arg(y3),
                                                               static_cast<unsigned int>(cuarma::traits::start(y3)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(y3)),
                                                               cuarma::cuda_arg(temp)
                                                              );
        CUARMA_CUDA_LAST_ERROR_CHECK("inner_prod_4_kernel");
        vector_multi_sum_kernel<<<4, CUARMA_MDOT_WORKGROUP_NUM>>>(cuarma::cuda_arg(temp),
                                                                    cuarma::cuda_arg(result),
                                                                    static_cast<unsigned int>(cuarma::traits::start(result) + cuarma::traits::stride(result) * current_index),
                                                                    static_cast<unsigned int>(cuarma::traits::stride(result))
                                                                   );
        CUARMA_CUDA_LAST_ERROR_CHECK("vector_multi_sum_kernel");
      }
        current_index += 4;
        break;
      case 3:
      {
        ...
        inner_prod_3_kernel<<<CUARMA_MDOT_WORKGROUP_NUM,
                              CUARMA_MDOT_WORKGROUP_SIZE>>>( cuarma::cuda_arg(x),
                                                               static_cast<unsigned int>(cuarma::traits::start(x)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(x)),
                                                               static_cast<unsigned int>(cuarma::traits::size(x)),
        ...
        CUARMA_CUDA_LAST_ERROR_CHECK("inner_prod_3_kernel");
        vector_multi_sum_kernel<<<3, CUARMA_MDOT_WORKGROUP_NUM>>>(cuarma::cuda_arg(temp),
                                                                    cuarma::cuda_arg(result),
                                                                    static_cast<unsigned int>(cuarma::traits::start(result) + cuarma::traits::stride(result) * current_index),
                                                                    static_cast<unsigned int>(cuarma::traits::stride(result))
                                                                   );
      ...
      case 2:
      {
        ...
        inner_prod_2_kernel<<<CUARMA_MDOT_WORKGROUP_NUM,
                              CUARMA_MDOT_WORKGROUP_SIZE>>>( cuarma::cuda_arg(x),
                                                               static_cast<unsigned int>(cuarma::traits::start(x)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(x)),
                                                               static_cast<unsigned int>(cuarma::traits::size(x)),
        ...
        CUARMA_CUDA_LAST_ERROR_CHECK("inner_prod_2_kernel");
        vector_multi_sum_kernel<<<2, CUARMA_MDOT_WORKGROUP_NUM>>>(cuarma::cuda_arg(temp),
                                                                    cuarma::cuda_arg(result),
                                                                    static_cast<unsigned int>(cuarma::traits::start(result) + cuarma::traits::stride(result) * current_index),
                                                                    static_cast<unsigned int>(cuarma::traits::stride(result))
                                                                   );
      ...
      {
        vector_base<NumericT> const & y0 = vec_tuple.const_at(current_index);
        inner_prod_kernel<<<128, 128>>>(cuarma::cuda_arg(x),
                                        static_cast<unsigned int>(cuarma::traits::start(x)),
                                        static_cast<unsigned int>(cuarma::traits::stride(x)),
                                        static_cast<unsigned int>(cuarma::traits::size(x)),
                                        cuarma::cuda_arg(y0),
                                        static_cast<unsigned int>(cuarma::traits::start(y0)),
                                        static_cast<unsigned int>(cuarma::traits::stride(y0)),
                                        static_cast<unsigned int>(cuarma::traits::size(y0)),
                                        cuarma::cuda_arg(temp)
                                       );
        CUARMA_CUDA_LAST_ERROR_CHECK("inner_prod_kernel");

        vector_multi_sum_kernel<<<1, 128>>>(cuarma::cuda_arg(temp),
                                            cuarma::cuda_arg(result),
                                            static_cast<unsigned int>(cuarma::traits::start(result) + cuarma::traits::stride(result) * current_index),
                                            static_cast<unsigned int>(cuarma::traits::stride(result))
                                           );
      ...
      default:
      {
        ...
        inner_prod_8_kernel<<<CUARMA_MDOT_WORKGROUP_NUM,
                              CUARMA_MDOT_WORKGROUP_SIZE>>>( cuarma::cuda_arg(x),
                                                               static_cast<unsigned int>(cuarma::traits::start(x)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(x)),
                                                               static_cast<unsigned int>(cuarma::traits::size(x)),
                                                               ...
                                                               static_cast<unsigned int>(cuarma::traits::stride(y3)),
                                                               cuarma::cuda_arg(y4),
                                                               static_cast<unsigned int>(cuarma::traits::start(y4)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(y4)),
                                                               cuarma::cuda_arg(y5),
                                                               static_cast<unsigned int>(cuarma::traits::start(y5)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(y5)),
                                                               cuarma::cuda_arg(y6),
                                                               static_cast<unsigned int>(cuarma::traits::start(y6)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(y6)),
                                                               cuarma::cuda_arg(y7),
                                                               static_cast<unsigned int>(cuarma::traits::start(y7)),
                                                               static_cast<unsigned int>(cuarma::traits::stride(y7)),
                                                               cuarma::cuda_arg(temp)
                                                              );
        CUARMA_CUDA_LAST_ERROR_CHECK("inner_prod_8_kernel");
        vector_multi_sum_kernel<<<8, CUARMA_MDOT_WORKGROUP_NUM>>>(cuarma::cuda_arg(temp),
                                                                    cuarma::cuda_arg(result),
                                                                    static_cast<unsigned int>(cuarma::traits::start(result) + cuarma::traits::stride(result) * current_index),
                                                                    static_cast<unsigned int>(cuarma::traits::stride(result))
                                                                   );
...
#undef CUARMA_MDOT_WORKGROUP_NUM
#undef CUARMA_MDOT_WORKGROUP_SIZE
...
namespace detail
{
  struct norm_kernel_launcher_integers
  {
    ...
    static void apply(vector_base<NumericT> const & vec1,
                      ...
                      unsigned int option)
    {
      norm_kernel_integers<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                         static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                         static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                         static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                         static_cast<unsigned int>(option),
      ...
      CUARMA_CUDA_LAST_ERROR_CHECK("norm_kernel");
    }
  };
  ...
  struct norm_kernel_launcher_unsigned_integers
  {
    ...
    static void apply(vector_base<NumericT> const & vec1,
                      ...
                      unsigned int option)
    {
      norm_kernel_unsigned_integers<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                                 static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                                 static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                                 static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                                 static_cast<unsigned int>(option),
  ...
  struct norm_kernel_launcher_floats
  {
    ...
    static void apply(vector_base<NumericT> const & vec1,
                      ...
                      unsigned int option)
    {
      norm_kernel_floats<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                       static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                       static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                       static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                       static_cast<unsigned int>(option),
              ...
              scalar<NumericT> & result)
{
  ...
  arma_size_t work_groups = 128;
  cuarma::vector<value_type> temp(work_groups, cuarma::traits::context(vec1));

  detail::norm_kernel_launcher<NumericT>::apply(vec1, temp, 4);

  vector_maxmin_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                   static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                   static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                   static_cast<unsigned int>(cuarma::traits::size(vec1)),
  ...
  CUARMA_CUDA_LAST_ERROR_CHECK("vector_maxmin_kernel");
}
              ...
              scalar<NumericT> & result)
{
  ...
  cuarma::vector<NumericT> all_ones = cuarma::scalar_vector<NumericT>(vec1.size(), NumericT(1), cuarma::traits::context(vec1));
  cuarma::blas::cuda::inner_prod_impl(vec1, all_ones, result);
}
             ...
             NumericT & result)
{
  ...
  cuarma::vector<NumericT> all_ones = cuarma::scalar_vector<NumericT>(vec1.size(), NumericT(1), cuarma::traits::context(vec1));
  cuarma::blas::cuda::inner_prod_cpu(vec1, all_ones, result);
}
...
arma_size_t index_norm_inf(vector_base<NumericT> const & vec1)
{
  ...
  cuarma::backend::mem_handle h;
  cuarma::backend::memory_create(h, sizeof(unsigned int), cuarma::traits::context(vec1));

  index_norm_inf_kernel<<<1, 128>>>(cuarma::cuda_arg(vec1),
                                    static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                    static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                    static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                    cuarma::cuda_arg<unsigned int>(h)
                                    //reinterpret_cast<unsigned int *>(h.cuda_handle().get())
                                  );
  CUARMA_CUDA_LAST_ERROR_CHECK("index_norm_inf_kernel");

  unsigned int ret = 0;
  cuarma::backend::memory_read(h, 0, sizeof(unsigned int), &ret);
  return static_cast<arma_size_t>(ret);
}
                    ...
                    NumericT alpha, NumericT beta)
{
  ...
  value_type temporary_alpha = 0;
  if (cuarma::is_cpu_scalar<value_type>::value)
    temporary_alpha = alpha;
  ...
  plane_rotation_kernel<<<128, 128>>>(cuarma::cuda_arg(vec1),
                                      static_cast<unsigned int>(cuarma::traits::start(vec1)),
                                      static_cast<unsigned int>(cuarma::traits::stride(vec1)),
                                      static_cast<unsigned int>(cuarma::traits::size(vec1)),
                                      cuarma::cuda_arg(vec2),
                                      ...
                                      cuarma::cuda_arg<value_type>(detail::arg_reference(alpha, temporary_alpha)),
                                      cuarma::cuda_arg<value_type>(detail::arg_reference(beta, temporary_beta)) );
  CUARMA_CUDA_LAST_ERROR_CHECK("plane_rotation_kernel");
}
...
namespace detail
{
  ...
  void scan_impl(vector_base<NumericT> const & input,
                 ...
                 bool is_inclusive)
  {
    arma_size_t block_num = 128;
    arma_size_t threads_per_block = 128;

    cuarma::backend::mem_handle cuda_carries;
    cuarma::backend::memory_create(cuda_carries, sizeof(NumericT)*block_num, cuarma::traits::context(input));

    // First step: Scan within each thread group and write carries
    scan_kernel_1<<<block_num, threads_per_block>>>(cuarma::cuda_arg(input),
                                                    static_cast<unsigned int>(cuarma::traits::start(input)),
                                                    static_cast<unsigned int>(cuarma::traits::stride(input)),
                                                    static_cast<unsigned int>(cuarma::traits::size(input)),

                                                    cuarma::cuda_arg(output),
                                                    static_cast<unsigned int>(cuarma::traits::start(output)),
                                                    static_cast<unsigned int>(cuarma::traits::stride(output)),

                                                    static_cast<unsigned int>(is_inclusive ? 0 : 1),
                                                    cuarma::cuda_arg<NumericT>(cuda_carries)
                                                   );

    // Second step: Compute offset for each thread group (exclusive scan for each thread group)
    scan_kernel_2<<<1, block_num>>>(cuarma::cuda_arg<NumericT>(cuda_carries));

    // Third step: Offset each thread group accordingly
    scan_kernel_3<<<block_num, threads_per_block>>>(cuarma::cuda_arg(output),
                                                    static_cast<unsigned int>(cuarma::traits::start(output)),
                                                    static_cast<unsigned int>(cuarma::traits::stride(output)),
                                                    static_cast<unsigned int>(cuarma::traits::size(output)),
