...
/** @file cuarma/blas/cuda/bisect_kernel_large_onei.hpp
 *  @encoding:UTF-8 文档编码
                               ...
                               NumericT  precision)
{
  ...
  __shared__  NumericT  s_left_scratch[CUARMA_BISECT_MAX_THREADS_BLOCK];
  __shared__  NumericT  s_right_scratch[CUARMA_BISECT_MAX_THREADS_BLOCK];
