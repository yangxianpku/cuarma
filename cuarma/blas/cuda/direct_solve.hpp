...
/** @file cuarma/blas/cuda/direct_solve.hpp
 *  @encoding:UTF-8 文档编码
...
namespace detail
{
  ...
  inline bool is_unit_solve(cuarma::blas::unit_lower_tag) { return true; }
  inline bool is_unit_solve(cuarma::blas::unit_upper_tag) { return true; }

  template<typename TagT>
  bool is_upper_solve(TagT const & tag) { return false; }

  inline bool is_upper_solve(cuarma::blas::upper_tag) { return true; }
  inline bool is_upper_solve(cuarma::blas::unit_upper_tag) { return true; }
  ...
  {
    typedef typename cuarma::result_of::cpu_value_type<Matrix1T>::type        value_type;
    ...
    {
      matrix_matrix_upper_solve_kernel<<<grid,threads>>>(cuarma::cuda_arg(A),
    ...
    {
      matrix_matrix_lower_solve_kernel<<<grid,threads>>>(cuarma::cuda_arg(A),
                                                         static_cast<unsigned int>(cuarma::traits::start1(A)),         static_cast<unsigned int>(cuarma::traits::start2(A)),
                                                         static_cast<unsigned int>(cuarma::traits::stride1(A)),        static_cast<unsigned int>(cuarma::traits::stride2(A)),
                                                         static_cast<unsigned int>(cuarma::traits::size1(A)),          static_cast<unsigned int>(cuarma::traits::size2(A)),
                                                         static_cast<unsigned int>(cuarma::traits::internal_size1(A)), static_cast<unsigned int>(cuarma::traits::internal_size2(A)),
...
namespace detail
{
  inline unsigned int get_option_for_solver_tag(cuarma::blas::upper_tag)      { return 0; }
  inline unsigned int get_option_for_solver_tag(cuarma::blas::unit_upper_tag) { return (1 << 0); }
  inline unsigned int get_option_for_solver_tag(cuarma::blas::lower_tag)      { return (1 << 2); }
  inline unsigned int get_option_for_solver_tag(cuarma::blas::unit_lower_tag) { return (1 << 2) | (1 << 0); }
  ...
  void inplace_solve_vector_impl(MatrixT const & mat,
                                 ...
                                 unsigned int options)
  {
    typedef typename cuarma::result_of::cpu_value_type<MatrixT>::type        value_type;

    if (mat.row_major())
    {
      triangular_substitute_inplace_row_kernel<<<1, 128>>>(cuarma::cuda_arg(mat),
    ...
    {
      triangular_substitute_inplace_col_kernel<<<1, 128>>>(cuarma::cuda_arg(mat),
                                                           static_cast<unsigned int>(cuarma::traits::start1(mat)),         static_cast<unsigned int>(cuarma::traits::start2(mat)),
                                                           static_cast<unsigned int>(cuarma::traits::stride1(mat)),        static_cast<unsigned int>(cuarma::traits::stride2(mat)),
                                                           static_cast<unsigned int>(cuarma::traits::size1(mat)),          static_cast<unsigned int>(cuarma::traits::size2(mat)),
                                                           static_cast<unsigned int>(cuarma::traits::internal_size1(mat)), static_cast<unsigned int>(cuarma::traits::internal_size2(mat)),
